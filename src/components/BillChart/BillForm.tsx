...
type Props = {
  initial: Bill | null; // null = new bill, Bill = editing
      ...
      <div className={styles.modal}>
        ...
        <div className={styles.modalBody}>
          ...
          <div className={styles.field}>
            <label className={styles.label} htmlFor="bill-name">
              Payee Name
            </label>
            <input
              id="bill-name"
          ...
          <div className={styles.row2}>
            ...
            <div className={styles.field}>
              <label className={styles.label} htmlFor="bill-due">
                Due Day (1–31)
              </label>
              <input
                id="bill-due"
          ...
          <div className={styles.row2}>
            <div className={styles.field}>
              <label className={styles.label} htmlFor="bill-method">
                Payment Method
              </label>
              <select
                id="bill-method"
            ...
            <div className={styles.field}>
              <label className={styles.label} htmlFor="bill-group">
                Paid From
              </label>
              <select
                id="bill-group"
          ...
          {/* Entry type */}
          <div className={styles.field}>
            <label className={styles.label} htmlFor="bill-entry">
              Entry Type
            </label>
            <select
              id="bill-entry"
          ...
          {/* Category */}
          <div className={styles.field}>
            <label className={styles.label} htmlFor="bill-category">
              Category
            </label>
            <select
              id="bill-category"
          ...
          {/* Notes */}
          <div className={styles.field}>
            <label className={styles.label} htmlFor="bill-notes">
              Notes
            </label>
            <textarea
              id="bill-notes"
